 ...
 *
 * Русское написание – без казахских букв, казахское лежит в `fullNameKk`
 * («Тест день 3», правило в docs/translation-rules.md).
 */
...
export const employees: EmployeeSeed[] = [
  ...
  {
    id: 'e-3',
    fullName: 'Сулейменова Айгерим Бакыткызы',
    fullNameGenitive: 'Сулейменову Айгерим Бакыткызы',
    fullNameKk: 'Сулейменова Айгерим Бақытқызы',
  ...
  },
  {
    ...
    fullNameGenitive: 'Жаксылыкову Динару Талгаткызы',
    fullNameKk: 'Жақсылықова Динара Талғатқызы',
