...
export const en: Dictionary = {
  ...
  archive: {
    ...
    exportCreated: 'Created in the system',
    exportUploaded: 'Uploaded as PDF',
    title: 'Archive',
    subtitle:
  ...
  templates: {
    create: 'New template',
    newTitle: 'New document template',
    editTitle: 'Document template',
    subtitle:
      'Your company template: other companies do not see it. Documents made from it come out on the group letterhead, with the logo, details and the director signature.',
    back: 'Back to the catalogue',
    noAccessTitle: 'No access to templates',
    noAccessBody: 'Templates are created by directors, administrators and people they gave access to.',
    notFound: 'The template is not found or cannot be edited',
    groupDocument: 'Document',
    groupBlank: 'Letterhead',
    groupFields: 'Form fields',
    groupText: 'Document text',
    title: 'Document name',
    titleHint: 'The name in the catalogue and in the registry.',
    titleEn: 'Name in English',
    titleEnHint: 'For the English interface. Optional.',
    purpose: 'When it is needed',
    purposeHint: 'One line under the form title. Optional.',
    section: 'Section',
    subsection: 'Subsection',
    series: 'Number series',
    heading: 'Heading on the letterhead',
    headingHint:
      'Printed in three languages, as on every document of the group: «Б Ұ Й Р Ы Қ / ПРИКАЗ / ORDER».',
    headingKk: 'In Kazakh',
    headingRu: 'In Russian',
    headingEn: 'In English',
    langs: 'Text languages',
    langsHint: 'The body of the document gets this many columns.',
    langsRu: 'Russian only',
    langsKkRu: 'Kazakh and Russian',
    langsAll: 'Kazakh, Russian and English',
    acquaint: 'Acknowledgement list under the signature',
    fieldsHint:
      'What people fill in when they create the document. A field goes into the text by its name in curly brackets.',
    fieldsEmpty: 'No fields yet: the document will have fixed text only.',
    fieldLabel: 'Field name',
    fieldKind: 'Type',
    fieldRequired: 'Required',
    fieldPerLang: 'Own value in each language',
    fieldOptions: 'Options, separated by commas',
    ...
    textHint:
      'One line is one paragraph. A field is its name in curly brackets: {Order date}. An employee in the case the order needs is {Employee|case}. Bold is **like this**.',
    textKk: 'Text in Kazakh',
    textRu: 'Text in Russian',
    textEn: 'Text in English',
    insert: 'Insert into the text',
    insertCase: 'in the case',
    insertCompany: 'Company details',
    problemsTitle: 'The template is not saved',
    problems: {
      title: 'Enter the document name.',
      section: 'Choose a section and a subsection.',
      heading: 'Fill in the heading in three languages.',
      langs: 'Choose the text languages.',
      body: 'Write the text in every chosen language.',
      'field-label': 'Every field needs a name.',
      'field-duplicate':
        'Field names must not repeat or match the company details («Company», «BIN», «City»…).',
      'field-options': 'A list needs at least two options.',
    } as Record<string, string>,
    denied: 'Not saved: you may not create templates in this section.',
    save: 'Save the template',
    remove: 'Remove the template',
    removeConfirm: 'Remove the template from the catalogue? Documents made from it stay as they are.',
    previewTitle: 'Company template – the text is not checked by a lawyer',
    previewBody:
      'The text was written in the company, not taken from a checked sample. Check the wording with a lawyer before issuing the document.',
    catalogMark: 'company template',
    edit: 'Edit',
    grantLabel: 'May create document templates',
    grantHint: 'In their own sections and only in their company. Directors and administrators always may.',
    grantBadge: 'templates',
  },
  ...
  admin: {
    ...
    events: {
      ...
      'template.update': 'Changed a template',
